...
public class AdminCheckUserVendor2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_check_user_vendor2);
        ...
        referenceFIR.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(AdminCheckUserVendor2.this, "Error: "+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (serialNo != null) {
            ...
            mBtnStolen.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(AdminCheckUserVendor2.this, AdminCheckUserVendor3.class);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        mBtnMob.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                final AlertDialog.Builder altdial = new AlertDialog.Builder(AdminCheckUserVendor2.this);
                        ...
                        mBtnInvoice.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                AlertDialog.Builder altdial = new AlertDialog.Builder(AdminCheckUserVendor2.this);
                                altdial.setCancelable(false)
                                        .setPositiveButton("Open Image", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(AdminCheckUserVendor2.this, "Record not found", Toast.LENGTH_SHORT).show();
                    }
                }
