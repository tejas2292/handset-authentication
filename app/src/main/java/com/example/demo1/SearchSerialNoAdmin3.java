...
public class SearchSerialNoAdmin3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_serial_no_admin3);
        ...
        referenceFIR.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(SearchSerialNoAdmin3.this, "Error.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SearchSerialNoAdmin3.this, "Error: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(SearchSerialNoAdmin3.this, SearchSerialNoAdmin2.class);
