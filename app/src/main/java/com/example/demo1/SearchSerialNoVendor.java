...
public class SearchSerialNoVendor extends AppCompatActivity {
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_serial_no_vendor);
        ...
        mSearchView = findViewById(R.id.searchView);
            ...
            final ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(SearchSerialNoVendor.this, android.R.layout.simple_list_item_1, myArrayList);
    ...
    public void onBackPressed() {
        startActivity(new Intent(SearchSerialNoVendor.this, MainActivityVendor.class));
        finish();
    }
}
