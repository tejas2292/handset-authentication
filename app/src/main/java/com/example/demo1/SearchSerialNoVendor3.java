...
public class SearchSerialNoVendor3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_serial_no_vendor3);

        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setTitle("FIR Information");
        setSupportActionBar(toolbar);

        mRemoveFIR = findViewById(R.id.btn_removeFIR);
        ...
        referenceFIR.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(SearchSerialNoVendor3.this, "Error.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SearchSerialNoVendor3.this, "Error: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mRemoveFIR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(SearchSerialNoVendor3.this, SearchSerialNoVendor4.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(SearchSerialNoVendor3.this, SearchSerialNoVendor2.class);
