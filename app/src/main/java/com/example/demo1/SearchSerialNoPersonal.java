...
public class SearchSerialNoPersonal extends AppCompatActivity {
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_serial_no_personal);
        ...
        final ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(SearchSerialNoPersonal.this, android.R.layout.simple_list_item_1, myArrayList);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(SearchSerialNoPersonal.this, SearchSerialNoPersonal2.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(SearchSerialNoPersonal.this, MainActivityPersonal.class));
        finish();
    }
}
