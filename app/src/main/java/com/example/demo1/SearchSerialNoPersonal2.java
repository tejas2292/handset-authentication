...
public class SearchSerialNoPersonal2 extends AppCompatActivity {
    ...
    String UNo, shopName, address, serialNo, serialNo2, buyerFirstName, buyerLastName, brandName,
            modelNo, warrantyDate, imgMob, imgInvoice, vendorPhoneNo, contactFirst;
    DatabaseReference referenceVendor, referenceFIR;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_search_serial_no_personal2);
        ...
        referenceFIR.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SearchSerialNoPersonal2.this, "Error: "+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        if (serialNo != null) {
            ...
            mBtnStolen.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(SearchSerialNoPersonal2.this, SearchSerialNoPersonal3.class);
...
*/
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        mBtnMob.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                final AlertDialog.Builder altdial = new AlertDialog.Builder(SearchSerialNoPersonal2.this);
                        ...
                        mBtnInvoice.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                AlertDialog.Builder altdial = new AlertDialog.Builder(SearchSerialNoPersonal2.this);
                                altdial.setCancelable(false)
                                        .setPositiveButton("Open Image", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(SearchSerialNoPersonal2.this, "Record not found", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(SearchSerialNoPersonal2.this, SearchSerialNoPersonal.class));
        finish();
    }
}
