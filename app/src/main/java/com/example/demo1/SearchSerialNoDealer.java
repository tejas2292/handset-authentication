...
public class SearchSerialNoDealer extends AppCompatActivity {
    ListView mListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_serial_no_dealer);
        ...
        final ArrayAdapter<String> myArrayAdapter = new ArrayAdapter<String>(SearchSerialNoDealer.this, android.R.layout.simple_list_item_1, myArrayList);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(SearchSerialNoDealer.this, SearchSerialNoDealer2.class);
    ...
    public void onBackPressed() {
        startActivity(new Intent(SearchSerialNoDealer.this, MainActivityDealer.class));
        finish();
    }
}
