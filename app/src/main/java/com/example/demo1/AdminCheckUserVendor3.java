...
public class AdminCheckUserVendor3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_check_user_vendor3);
        ...
        referenceFIR.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(AdminCheckUserVendor3.this, "Error.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(AdminCheckUserVendor3.this, "Error: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdminCheckUserVendor3.this, AdminCheckUserVendor2.class);
